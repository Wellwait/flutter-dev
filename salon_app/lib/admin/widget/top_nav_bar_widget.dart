...
import '../salon_documents/salon_documents_page.dart';
import '../salon_information/salon_information_page.dart';
import '../salon_service/salon_service_page.dart';
...
class _StepperNavBarState extends State<StepperNavBar> {
  ...
  Widget _buildStepCircle(int index) {
    bool isCompleted = _selectedIndex > index;  // Step is completed if current index is greater
    ...
    return Container(
      ...
      child: Center(
        child: isCompleted
          ...
          child: Icon(Icons.check, color: isCompleted ? Colors.white : Colors.transparent, size: 16)
        )
            : Container(
          decoration: BoxDecoration(
            shape: BoxShape.circle,
