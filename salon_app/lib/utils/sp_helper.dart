...
class SharedPreferenceService {
  ...
  static const String _originalIdKey = 'originalId';
  ...
  Future<void> saveAdminCredentials(String email, String password,int status) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
  ...
  Future<void> saveUserPhoneNumber(String userPhoneNumber) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setString(_userPhoneNumberKey, userPhoneNumber); // Save username
  }
  ...
  Future<void> saveOriginalId(int originalId) async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    await prefs.setInt(_originalIdKey, originalId);
  }

  // Get originalId
  Future<int?> getOriginalId() async {
    final SharedPreferences prefs = await SharedPreferences.getInstance();
    return prefs.getInt(_originalIdKey);
  }
