...
class SPDetailViewModel extends ChangeNotifier {
  ...
  void onServiceAdded(String title, String subtitle, String imagePath, int serviceId, int panelId) {
  ...
  void onServiceRemoved(int serviceId,int panelId) {
    selectedServices.removeWhere((service) => service['id'] == serviceId.toString() && service['panelId'] == panelId.toString());
